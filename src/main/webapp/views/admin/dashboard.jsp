...
<%--            &lt;%&ndash; PHÂN QUYỀN: ADMIN HIỂN THỊ TẤT CẢ &ndash;%&gt;--%>
...
<%--            &lt;%&ndash; PHÂN QUYỀN: MASTER CHỈ HIỂN THỊ 3 CHỨC NĂNG THEO YÊU CẦU &ndash;%&gt;--%>
...
<%--                            &lt;%&ndash; Hiển thị tên Role động &ndash;%&gt;--%>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card-dashboard">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/users" class="btn btn-primary w-100">Truy cập</a>
                </div>
            </div>
        </div>
    </div>
